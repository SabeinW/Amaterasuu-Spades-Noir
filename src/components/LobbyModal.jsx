...
export default function LobbyModal({ user, profile, onClose, onEnterRoom, onRequireAuth, defaultRules }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
      <div className="w-full max-w-sm max-h-[85vh] rounded-2xl animate-fadeUp flex flex-col overflow-hidden" style={{ background: 'rgba(14,11,22,0.97)', border: '1px solid rgba(167,139,250,0.3)' }}>
